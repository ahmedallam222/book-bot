...
**Approach:** shell-only against the live production server `ubuntu@<production-host>` (no Telegram UI). Two real search jobs were enqueued through Redis into the deployed worker; bundle contents and Firecrawl responses were inspected directly.
