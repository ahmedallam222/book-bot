...
> **سيرفر الإنتاج:** `ubuntu@54.196.55.152` — مسار المشروع `/home/ubuntu/book-bot/`.
...
```bash
ssh ubuntu@54.196.55.152 "cd /home/ubuntu/book-bot && git pull origin main && docker compose up -d --build"
```
