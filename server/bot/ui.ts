...
const TIPS_FREE = [
  ...
  "🪄 _اكتب اسم الكتاب فقط — زي: الأمير الصغير_",
  "⚡ _لو طلبت الكتاب قبل كده… هيوصلك أسرع_",
  "📘 _بعد التحميل: اضغط «ملخّص سريع» لو حابب_",
  "👥 _في الجروب: اكتب اسم الكتاب مباشرة_",
  ...
  "🎯 _اكتب العنوان… من غير كلمة pdf أو تحميل_",
