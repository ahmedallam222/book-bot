...
const ARABIC_NOISE_WORDS: string[] = [
  // نيّة التحميل/القراءة
  "تحميل", "تنزيل", "حمّل", "حمل", "نزّل", "نزل",
  "اقرأ", "قراءة",
...
// تشمل: نوع الكتاب (كتاب/رواية/...) + نيّة التلخيص حتى نتعامل
// مع "لخصلي كتاب الأمير الصغير" → loop يُزيل الاثنين على التوالي.
const LEADING_NOISE = /^(?:كتاب|رواية|قصة|ديوان|كتب|روايات|لخصلي|لخّصلي|لخّص\s+لي|لخص\s+لي|لخّص|لخص|ملخص|ملخّص|مُلخّص|تلخيص|اختصرلي|اختصر\s+لي|اختصر)\s+/i;
