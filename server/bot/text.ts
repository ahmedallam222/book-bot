...
const CLEAN_LEADING = /^(?:كتاب|رواية|روايه|قصة|قصه|كتيب|كتب|روايات|قصص|ديوان|تحميل|تنزيل|حمّل|نزّل|اقرأ|قراءة|لخصلي|لخّصلي|لخّص\s+لي|لخص\s+لي|لخّص|لخص|ملخص|ملخّص|مُلخّص|تلخيص|اختصرلي|اختصر\s+لي|اختصر|ابغي|ابغى|ابي|أبي|اريد|أريد|ممكن|اجيب|أجيب|اطلب|أطلب|ارسل\s*لي|ابعت\s*لي|ارسل|ابعت)\s+/i;
